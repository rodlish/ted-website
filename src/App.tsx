...
const Hero = () => {
  const heroImages = [
    'https://ted-companygroup.com/image/2.jpg',
    'https://ted-companygroup.com/image/5.jpg',
    'https://ted-companygroup.com/image/6.jpg',
    'https://ted-companygroup.com/image/1.jpg'
  ];
  ...
  return (
    <section className="relative pt-32 pb-20 overflow-hidden min-h-screen flex items-center">
      ...
      <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center">
        ...
        >
          <div className="relative z-10 glass rounded-[3rem] p-6 shadow-2xl shadow-blue-500/20">
            <div className="bg-zinc-900 rounded-[2.5rem] overflow-hidden aspect-[4/3] relative">
              <AnimatePresence>
                <motion.img 
              ...
              <motion.div 
                animate={{ rotate: 360 }}
                transition={{ duration: 20, repeat: Infinity, ease: "linear" }}
                className="absolute top-10 right-10 w-24 h-24 border-2 border-dashed border-blue-500/30 rounded-full flex items-center justify-center z-10"
              >
              ...
              {services
                ...
                .map((service, index) => (
                  <motion.div
                    ...
                    className="glass p-8 rounded-[2.5rem] group cursor-pointer relative overflow-hidden border border-white/5 hover:border-blue-500/30 transition-all duration-500"
                  >
                    <div className={`absolute top-0 right-0 w-32 h-32 bg-gradient-to-br ${service.color} opacity-0 group-hover:opacity-20 transition-opacity blur-[60px]`} />
                    
                    <motion.div 
                      whileHover={{ rotate: [0, -10, 10, 0], scale: 1.1 }}
                      className={`w-12 h-12 rounded-xl bg-gradient-to-br ${service.color} p-3 mb-6 shadow-2xl shadow-blue-500/20`}
                    >
...
const SpecialOffer = () => {
  ...
  const y = useTransform(scrollYProgress, [0, 0.75, 1], ["0%", "0%", "-33%"]);

  return (
    <section ref={sectionRef} id="offre-speciale" className="relative bg-zinc-950 overflow-visible">
      <div className="grid grid-cols-1 items-start">
        {/* Sticky Image Container - Expertise BPO & Externalisation */}
        ...
        {/* Content Overlay Layer - SEO Keywords included */}
        <div className="col-start-1 row-start-1 z-10 w-full flex items-center py-24 md:py-48 min-h-[300vh]">
          <div className="max-w-7xl mx-auto px-6 w-full">
            <motion.div 
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              className="lg:w-1/2 bg-zinc-950/60 backdrop-blur-lg p-8 md:p-12 rounded-[3rem] border border-white/10 shadow-2xl"
            >
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-blue-500/20 border border-blue-500/40 text-blue-400 text-xs font-bold uppercase tracking-widest mb-8 backdrop-blur-md">
                ⚡ Offre BPO & Externalisation Exclusive
              </div>
              
              <h2 className="text-5xl md:text-7xl font-black mb-6 text-white leading-tight drop-shadow-2xl">
                Déléguez votre <span className="text-gradient">BPO pour 6€ / hr</span>.
              </h2>

              <p className="text-xl md:text-2xl text-white font-medium mb-12 max-w-2xl leading-relaxed drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)]">
                Boostez votre rentabilité grâce à l'externalisation stratégique. <br />
                Experts en <strong>Marketing, RH, Secrétariat et Relation Client</strong> au tarif unique de <strong>6€ l'heure travaillée</strong>. 
                Solution agile, sans engagement et sans charges fixes.
              </p>

              <div className="grid md:grid-cols-2 gap-6 mb-12">
                <div className="glass p-6 md:p-8 rounded-3xl border-white/10 bg-zinc-950/80 backdrop-blur-md">
                  <div className="text-zinc-400 text-xs font-bold uppercase tracking-widest mb-4">Coût Structure Classique</div>
                  <div className="text-3xl font-bold text-white decoration-red-500/50 decoration-4 line-through">3 000€ / mois</div>
                </div>
                <div className="glass p-6 md:p-8 rounded-3xl border-blue-500/30 bg-blue-500/10 backdrop-blur-sm relative overflow-hidden">
                  <div className="absolute top-0 right-0 p-4">
                    <Zap className="w-6 h-6 text-blue-500 animate-pulse" />
                  </div>
                  <div className="text-blue-400 text-xs font-bold uppercase tracking-widest mb-4">Modèle Agile Ted-Company</div>
                  <div className="text-5xl font-black text-blue-500">6€ / H</div>
                </div>
              </div>
              ...
              <div className="flex flex-wrap items-center gap-8">
                <Link 
                  to="/demarrer-un-projet"
                  className="bg-blue-500 text-zinc-950 px-10 py-5 rounded-2xl font-bold text-lg hover:bg-blue-400 transition-all shadow-2xl shadow-blue-500/40 flex items-center gap-3"
                >
                  Activer mon offre Outsourcing <Zap className="w-6 h-6" />
                </Link>
                
                <div className="flex flex-col gap-2">
                  <div className="flex items-center gap-2 text-white font-bold drop-shadow-md">
                    <CheckCircle2 className="text-emerald-400 w-5 h-5" />
                    <span>Externalisation Zéro Risque</span>
                  </div>
                  <div className="flex items-center gap-2 text-white font-bold drop-shadow-md">
                    <CheckCircle2 className="text-emerald-400 w-5 h-5" />
                    <span>Expertise Qualifiée</span>
                  </div>
                </div>
              </div>
            </motion.div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-32">
          {features.map((f, i) => (
            <motion.div
              ...
              transition={{ delay: i * 0.1 }}
              whileHover={{ y: -10 }}
              className="glass p-5 md:p-6 rounded-3xl border border-white/5 hover:border-blue-500/30 transition-all group"
            >
              <div className="w-12 h-12 rounded-xl bg-blue-500/10 flex items-center justify-center mb-5 group-hover:bg-blue-500 group-hover:text-zinc-950 transition-all">
  ...
  return (
    <div className="pt-32 pb-20 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-32">
          {features.map((f, i) => (
            <motion.div key={i} initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.1 }} className="glass p-5 md:p-6 rounded-3xl border border-white/5 hover:border-emerald-500/30 transition-all group">
              <div className="w-12 h-12 rounded-xl bg-emerald-500/10 flex items-center justify-center mb-5 group-hover:bg-emerald-500 group-hover:text-zinc-950 transition-all">
                <f.icon className="w-6 h-6" />
              </div>
              <h3 className="text-lg md:text-xl font-bold mb-3">{f.title}</h3>
              <p className="text-zinc-400 text-xs md:text-sm leading-relaxed">{f.desc}</p>
  ...
  return (
    <div className="pt-32 pb-20 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-32">
          {features.map((f, i) => (
            <motion.div key={i} initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.1 }} className="glass p-5 md:p-6 rounded-3xl border border-white/5 hover:border-purple-500/30 transition-all group">
              <div className="w-12 h-12 rounded-xl bg-purple-500/10 flex items-center justify-center mb-5 group-hover:bg-purple-500 group-hover:text-zinc-950 transition-all">
                <f.icon className="w-6 h-6" />
              </div>
              <h3 className="text-lg md:text-xl font-bold mb-3">{f.title}</h3>
              <p className="text-zinc-400 text-xs md:text-sm leading-relaxed">{f.desc}</p>
            ...
            >
              <div className="relative z-10 rounded-[3rem] overflow-hidden shadow-2xl border border-white/10">
                <motion.img 
                  ...
                  transition={{ duration: 10, repeat: Infinity }}
                  src="/regenerated_image_1777287509090.png" 
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-32">
          ...
          <motion.div 
            ...
            className="relative"
          >
            <div className="glass rounded-[3rem] p-4 overflow-hidden shadow-2xl relative group">
              <img 
                src="https://images.unsplash.com/photo-1629904853716-f0bc54eea481?auto=format&fit=crop&q=80&w=1200" 
                alt="Technicien support technique" 
                className="w-full h-auto rounded-[2.5rem] transition-transform duration-700 group-hover:scale-105"
                referrerPolicy="no-referrer"
              />
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-32">
          {features.map((f, i) => (
            <motion.div key={i} initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.1 }} className="glass p-5 md:p-6 rounded-3xl border border-white/5 hover:border-blue-500/30 transition-all group">
              <div className="w-12 h-12 rounded-xl bg-blue-500/10 flex items-center justify-center mb-5 group-hover:bg-blue-500 group-hover:text-zinc-950 transition-all">
                <f.icon className="w-6 h-6" />
              </div>
              <h3 className="text-lg md:text-xl font-bold mb-3">{f.title}</h3>
  ...
  return (
    <div className="pt-32 pb-20 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-32">
          {features.map((f, i) => (
            <motion.div key={i} initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.1 }} className="glass p-5 md:p-6 rounded-3xl border border-white/5 hover:border-orange-500/30 transition-all group">
              <div className="w-12 h-12 rounded-xl bg-orange-500/10 flex items-center justify-center mb-5 group-hover:bg-orange-500 group-hover:text-zinc-950 transition-all">
                <f.icon className="w-6 h-6" />
              </div>
              <h3 className="text-lg md:text-xl font-bold mb-3">{f.title}</h3>
              <p className="text-zinc-400 text-xs md:text-sm leading-relaxed">{f.desc}</p>
  ...
  return (
    <div className="pt-32 pb-20 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-32">
          {features.map((f, i) => (
            <motion.div key={i} initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.1 }} className="glass p-5 md:p-6 rounded-3xl border border-white/5 hover:border-indigo-500/30 transition-all group">
              <div className="w-12 h-12 rounded-xl bg-indigo-500/10 flex items-center justify-center mb-5 group-hover:bg-indigo-500 group-hover:text-zinc-950 transition-all">
                <f.icon className="w-6 h-6" />
              </div>
              <h3 className="text-lg md:text-xl font-bold mb-3">{f.title}</h3>
              <p className="text-zinc-400 text-xs md:text-sm leading-relaxed">{f.desc}</p>
  ...
  return (
    <div className="pt-32 pb-20 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-32">
          {features.map((f, i) => (
            <motion.div key={i} initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.1 }} className="glass p-5 md:p-6 rounded-3xl border border-white/5 hover:border-rose-500/30 transition-all group">
              <div className="w-12 h-12 rounded-xl bg-rose-500/10 flex items-center justify-center mb-5 group-hover:bg-rose-500 group-hover:text-zinc-950 transition-all">
                <f.icon className="w-6 h-6" />
              </div>
              <h3 className="text-lg md:text-xl font-bold mb-3">{f.title}</h3>
              <p className="text-zinc-400 text-xs md:text-sm leading-relaxed">{f.desc}</p>
  ...
  return (
    <div className="pt-32 pb-20 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 max-w-7xl mx-auto">
            {articles.map((article, i) => (
              ...
              >
                ...
                <div className="p-5">
                  <span className="text-[10px] font-bold text-cyan-400 uppercase tracking-widest mb-2 block">{article.tag}</span>
                  <h3 className="text-base font-bold mb-2 group-hover:text-blue-400 transition-colors leading-tight line-clamp-2">
                    {article.title}
                  </h3>
                </div>
              </motion.div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-32">
          {features.map((f, i) => (
            <motion.div key={i} initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.1 }} className="glass p-5 md:p-6 rounded-3xl border border-white/5 hover:border-cyan-500/30 transition-all group">
              <div className="w-12 h-12 rounded-xl bg-cyan-500/10 flex items-center justify-center mb-5 group-hover:bg-cyan-500 group-hover:text-zinc-950 transition-all">
                <f.icon className="w-6 h-6" />
              </div>
              <h3 className="text-lg md:text-xl font-bold mb-3">{f.title}</h3>
              <p className="text-zinc-400 text-xs md:text-sm leading-relaxed">{f.desc}</p>
  ...
  return (
    <div className="pt-32 pb-20 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-32">
          ...
          <div className="relative">
            <div className="glass rounded-[3rem] p-4 overflow-hidden shadow-2xl">
              <img 
                src="/regenerated_image_1777403625698.png" 
                alt="Solutions RH & Recrutement" 
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 my-32">
          {features.map((f, i) => (
            <motion.div key={i} initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.1 }} className="glass p-5 md:p-6 rounded-3xl border border-white/5 hover:border-orange-500/30 transition-all group">
              <div className="w-12 h-12 rounded-xl bg-orange-500/10 flex items-center justify-center mb-5 group-hover:bg-orange-500 group-hover:text-zinc-950 transition-all">
                <f.icon className="w-6 h-6" />
    ...
    <div className="pt-32 pb-20 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-32">
          ...
          <div className="relative">
            <div className="glass rounded-[3rem] p-4 overflow-hidden">
              <img src="/regenerated_image_1777285740684.png" alt="Médical" className="w-full rounded-[2.5rem]" referrerPolicy="no-referrer" />
            </div>
          </div>
        </div>
  ...
  return (
    <div className="pt-32 pb-20 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-32">
          {features.map((f, i) => (
            <motion.div key={i} initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.1 }} className="glass p-5 md:p-6 rounded-3xl border border-white/5 hover:border-pink-500/30 transition-all group">
              <div className="w-12 h-12 rounded-xl bg-pink-500/10 flex items-center justify-center mb-5 group-hover:bg-pink-500 group-hover:text-zinc-950 transition-all">
                <f.icon className="w-6 h-6" />
              </div>
              <h3 className="text-lg md:text-xl font-bold mb-3">{f.title}</h3>
              <p className="text-zinc-400 text-xs md:text-sm leading-relaxed">{f.desc}</p>
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          {[
            ...
            { title: 'Flexibilité', desc: 'Des solutions sur mesure adaptées à vos besoins.' }
          ].map((item, i) => (
            <motion.div 
              key={i}
              initial={{ opacity: 0, y: 20 }}
            ...
            >
              <h4 className="text-lg font-bold mb-3 text-blue-400">{item.title}</h4>
