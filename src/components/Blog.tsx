    ...
    const fetchPosts = async () => {
      ...
      try {
        ...
        setPosts([
          {
            id: '2',
            title: 'Pourquoi Madagascar est le Hub BPO & Outsourcing de Demain',
            slug: 'madagascar-hub-bpo',
            excerpt: 'Antananarivo s\'impose comme la destination leader pour l\'externalisation de services BPO bilingue. Découvrez les avantages stratégiques de Madagascar.',
          ...
          {
            id: '3',
            title: '7 Stratégies de Relation Client pour Booster votre Rétention',
            slug: 'conseils-relation-client',
            excerpt: 'Optimisez votre support client et votre SAV avec des techniques d\'externalisation éprouvées pour une expérience utilisateur premium.',
          ...
          },
          {
            ...
            excerpt: 'Découvrez comment une gestion stratégique du SAV externalisé peut renforcer la fidélité de vos clients et générer des ventes additionnelles.',
            content: '...',
          ...
          },
          {
            ...
            excerpt: 'Explorez les raisons pour lesquelles Antananarivo est devenue la capitale africaine de l\'outsourcing et du BPO francophone de haute performance.',
            content: '...',
          ...
          },
          {
            ...
            excerpt: 'Déléguez vos tâches RH et administratives à des experts BPO pour vous concentrer sur votre stratégie de croissance et réduire vos coûts fixes.',
            content: '...',
